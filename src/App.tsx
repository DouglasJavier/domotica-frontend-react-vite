...
import { Activar_desactivar } from './pages/Activar_desactivar'
import { Alarmas_conf } from './pages/Alarmas_conf'
...
function App() {
  ...
  const [openMenuSide, setOpenMenuSide] = useState<boolean>(sm || xs || md ? false : true);
      ...
      >
        <Routes >
          ...
          >
            ...
            <Route path="activar_desactivar" element = {<Activar_desactivar/>}/> 
            <Route path="incidentes" element = {<Incidentes_historial/>} />
            <Route path="/historial_activ_desact" element = {<Activ_desac_historial/>}/>
            <Route path="/simulacion_presencia" element = {<Simulacion_presencia_conf/>}/>
            <Route path="config_alarmas" element = {<Alarmas_conf/>}/>
